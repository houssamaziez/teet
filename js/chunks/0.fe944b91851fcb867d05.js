...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    filtredCategories: function filtredCategories() {
      ...
      return this.categories.filter(function (category) {
        return !_this.subCategoriesSections.some(function (topCategory) {
    ...
    filtredEditCategories: function filtredEditCategories() {
      var _this2 = this;
      return this.categories.filter(function (category) {
        return !_this2.subCategoriesSections.some(function (topCategory) {
  ...
  methods: {
    ...
    getSubCategoriesSections: function getSubCategoriesSections() {
      ...
      return new Promise(function (resolve, reject) {
        axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/api/sub-categories-sections/").then(function (result) {
          _this4.loader.hide();
          _this4.subCategoriesSections = result.data;
          resolve(result);
        })["catch"](function (err) {
          _this4.loader.hide();
          reject(err);
    ...
    openEditSidebar: function openEditSidebar(subCategoriesSection) {
      this.current = subCategoriesSection;
      this.$root.$emit("bv::toggle::collapse", "edit-category-sidebar");
    },
    openChangeStatusModal: function openChangeStatusModal(subCategoriesSection) {
      this.current = subCategoriesSection;
      ...
      return new Promise(function (resolve, reject) {
        axios__WEBPACK_IMPORTED_MODULE_2___default.a.patch("/api/sub-categories-sections/changeStatus/" + _this5.current.id).then(function (result) {
          ...
          _this5.$toast({
            ...
            props: {
              title: "Sub categories section status changed successufully",
              icon: "CheckIcon",
              variant: "success"
            }
          });
          ...
          _this5.$toast({
            component: _components_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_4__["default"],
            props: {
              title: "Cannot change sub categories section status",
...
/* harmony import */ var _components_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @/components/ToastificationContent.vue */ "./resources/js/src/components/ToastificationContent.vue");
    ...
    save: function save() {
      ...
      this.$refs.categoryAddValidation.validate().then(function (success) {
        if (success) {
          ...
          return new Promise(function (resolve, reject) {
            axios__WEBPACK_IMPORTED_MODULE_5___default.a.post("/api/sub-categories-sections/add", {
              title: _this.title,
              category_id: _this.category_id
            }).then(function (result) {
              _this.loader.hide();
              _this.$toast({
                component: _components_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
                props: {
                  title: "Sub categories section added successufully",
                  icon: "CheckIcon",
                  variant: "success"
                }
              });
              _this.$bus.emit("refresh-sub-categories-sections");
              _this.visible = false;
              resolve(result);
            })["catch"](function (err) {
              _this.loader.hide();
              _this.$toast({
                component: _components_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
                props: {
                  title: "Cannot add sub categories section",
                  icon: "AlertCircleIcon",
                  variant: "danger"
                }
              });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    visible: function visible(val) {
      if (val) {
        this.title = this.subCategoriesSection.title;
        this.category_id = this.subCategoriesSection.category_id;
      }
    }
  },
  methods: {
    save: function save() {
      ...
      this.$refs.categoryEditValidation.validate().then(function (success) {
        if (success) {
          _this.loader = _this.$loading.show();
          return new Promise(function (resolve, reject) {
            axios__WEBPACK_IMPORTED_MODULE_5___default.a.put("/api/sub-categories-sections/update/" + _this.subCategoriesSection.id, {
              title: _this.title,
              category_id: _this.category_id
            }).then(function (result) {
              _this.loader.hide();
              _this.$toast({
                component: _components_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
                props: {
                  title: "Sub categories section updated successufully",
                  icon: "CheckIcon",
                  variant: "success"
                }
              });
              ...
              _this.$toast({
                component: _components_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
                props: {
                  title: "Cannot update sub categories section",
                  icon: "AlertCircleIcon",
                  variant: "danger"
                }
              });
...
var render = function () {
  ...
  return _c(
    ...
    [
      _c("edit-sidebar", {
        attrs: {
          subCategoriesSection: _vm.current,
            ...
            [
              _c("b-table", {
                attrs: {
                  ...
                  "show-empty": "",
                  responsive: "sm",
                  items: _vm.subCategoriesSections,
                  fields: _vm.fields,
                },
                scopedSlots: _vm._u([
                  {
  ...
  return _c(
    ...
    [
      _c(
        ...
        [_vm._v("\n    " + _vm._s(_vm.$t("Add_Sub_Category_Section")) + "\n  ")]
      ),
      _vm._v(" "),
      _c(
        "b-sidebar",
        {
          attrs: {
            ...
            "bg-variant": "white",
            title: _vm.$t("Add_Sub_Category_Section"),
            right: "",
            backdrop: "",
            shadow: "",
          },
      ...
      _c(
        "b-sidebar",
        {
          attrs: {
            ...
            "bg-variant": "white",
            title: _vm.$t("Edit_Sub_Category_Section"),
            right: "",
            backdrop: "",
            shadow: "",
          },
