    ...
    save: function save() {
      ...
      this.$refs.courseAddValidation.validate().then(function (success) {
        if (success) {
          ...
          formData.append("price_group", _this2.priceGroup);
          formData.append("price_individual", _this2.priceIndividual);
          formData.append("sessions_number", _this2.sessionsNumber);
          formData.append("session_duration", _this2.sessionDuration);
          formData.append("curriculum", _this2.curriculum);
          formData.append("duration_weeks", _this2.durationWeeks);
          ...
          _this2.loader = _this2.$loading.show();
          return new Promise(function (resolve, reject) {
                ...
                [
                  _c(
                    ...
                    [
                                      ...
                                      _c(
                                        ...
                                        [
                                          _c(
                                            ...
                                            {
                                              attrs: {
                                                label: _vm.$t("PriceGroup"),
                                                "label-for": "v-price-group",
                                              },
                                            },
                                            [
                                              _c(
                                                ...
                                                [
                                                  _c("b-form-input", {
                                                    ...
                                                    model: {
                                                      value: _vm.priceGroup,
                                                      callback: function ($$v) {
                                                        _vm.priceGroup = $$v
                                                      },
                                                      expression: "priceGroup",
                                                    },
                                                  }),
                                                ],
                                                1
                      ...
                      _c("validation-provider", {
                        staticClass: "w-100",
                        attrs: { name: "Duration Weeks", rules: "required" },
                        scopedSlots: _vm._u([
                          {
                            key: "default",
                            fn: function (ref) {
                                ...
                                _c(
                                  ...
                                  [
                                    _c(
                                      ...
                                      {
                                        attrs: {
                                          label: _vm.$t("Duration_Weeks"),
                                          "label-for": "v-duration-weeks",
                                        },
                                      },
                                      [
                                        _c("b-form-input", {
                                          attrs: {
                                            id: "v-duration-weeks",
                                            placeholder:
                                              _vm.$t("Duration_Weeks"),
                                            type: "number",
                                          },
                                          model: {
                                            value: _vm.durationWeeks,
                                            callback: function ($$v) {
                                              _vm.durationWeeks = $$v
                                            },
                      ...
                      _c("validation-provider", {
                        staticClass: "w-100",
                        attrs: { name: "Curriculum", rules: "required" },
                        scopedSlots: _vm._u([
                          {
                            key: "default",
                            fn: function (ref) {
                    ...
                    [
                      _c(
                        ...
                        [
                          ...
                          _vm._v(" "),
                          _c("b-card-title", { staticClass: "mb-1" }, [
                            _vm._v(_vm._s(_vm.course.price_group) + " DA"),
                          ]),
                          _vm._v(" "),
                          _c("b-card-sub-title", { staticClass: "mb-2" }, [
                            _vm._v(_vm._s(_vm.$t("PriceGroup"))),
                          ]),
                          _vm._v(" "),
                          _c("b-card-title", { staticClass: "mb-1" }, [
                            _vm._v(_vm._s(_vm.course.price_individual) + " DA"),
                          ]),
                          _vm._v(" "),
                          _c("b-card-sub-title", { staticClass: "mb-2" }, [
                            _vm._v(_vm._s(_vm.$t("PriceIndividual"))),
                          ]),
                          _vm._v(" "),
                          _c("b-card-title", { staticClass: "mb-1" }, [
                            _vm._v(
                          ...
                          _c("b-card-title", { staticClass: "mb-1" }, [
                            _vm._v(
                              _vm._s(
                                _vm.course.Duration_Weeks == 1
                                  ? _vm.course.Duration_Weeks +
                                      " " +
                                      _vm.$t("Week")
                                  : _vm.course.Duration_Weeks +
                                      " " +
                          ...
                          _vm._v(" "),
                          _c("b-card-title", { staticClass: "mb-1" }, [
                            _vm._v(_vm._s(_vm.course.curriculum)),
                          ]),
                          _vm._v(" "),
                          _c("b-card-sub-title", { staticClass: "mb-2" }, [
                            _vm._v(_vm._s(_vm.$t("Curriculum"))),
                          ]),
                          _vm._v(" "),
                          _vm._l(
